...
# need to modify algorithm such that granularity other than hours can be used.
    # idea: use units_in_minutes from input event to modify tariff vector
...
#TODO currently tomeslot_start is just an element in the price vector. For now is simple solution.
